...
function ProductCard({
    ...
    return (
        <div className="flex flex-col md:flex-row w-full border rounded-xl border-gray-100 overflow-hidden shadow-sm hover:shadow-md transition-shadow">
            {/* Изображение */}
            ...
            <div className="flex flex-col justify-between gap-2 p-4 w-full md:w-[50%]">
                ...
                <div className="flex flex-row justify-between items-center">
                    ...
                    <button
                        ...
                        className="px-4 md:px-5 py-1 md:py-2 bg-blue-500 hover:bg-blue-600 text-white transition-colors rounded-lg md:rounded-xl flex items-center gap-2"
